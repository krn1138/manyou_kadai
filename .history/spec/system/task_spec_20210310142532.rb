...
describe 'タスク管理機能', type: :system do
  before do
    ...
    admin_user_two = FactoryBot.create(:admin_user_two)
    visit new_session_path
    fill_in 'session[email]', with: admin_user.email
    fill_in 'session[password]', with: admin_user.password
    click_button 'Log in'
    FactoryBot.create(:task, admin_user: admin_user)
    FactoryBot.create(:tasktwo, admin_user: admin_user)
    FactoryBot.create(:taskthree, admin_user_two: admin_user_two)
  end
